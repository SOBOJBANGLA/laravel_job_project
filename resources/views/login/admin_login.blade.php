...
<head>
  ...
  <link rel="stylesheet" href="{{asset('css/bootstrap.min.css')}}" type="text/css">- Our Website CSS Styles -->
          ...
          <form method="POST" action="{{ route('admin.login') }}">
            ...
            <div class="row mrg10">
              <div class="col-md-12 col-sm-12 col-lg-12">
                <input class="brd-rd5" type="text" name="email" placeholder="User Name" />
              </div>
              <div class="col-md-12 col-sm-12 col-lg-12">
                <input class="brd-rd5" type="password" name="password" placeholder="Password" />
              </div>
              <div class="col-md-12 col-sm-12 col-lg-12">
                <span class="chbx">
