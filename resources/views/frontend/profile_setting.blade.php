                ...
                <div class="rounded shadow p-4">
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label fw-semibold">First Name:<span class="text-danger">*</span></label>
                                    <input name="fname"  value="{{old('fname')}}" id="firstname" type="text" class="form-control" placeholder="First Name :">
                                </div>
                            </div><!--end col-->
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input name="lname" value="{{old('lname')}}" id="lastname" type="text" class="form-control" placeholder="Last Name :">
                                </div>
                            </div><!--end col-->
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input id="number" name="phone" value="{{old('phone')}}" type="text" class="form-control" placeholder="Phone :">
                                </div>
                            </div><!--end col-->
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="address" id="comments2" rows="4" class="form-control" placeholder="Address">{{old('address')}}</textarea>
                                </div>
                            </div><!--end col-->
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="about" id="comments2" rows="4" class="form-control" placeholder="Introduction :">{{old('about')}}</textarea>
                                </div>
                            </div><!--end col-->
