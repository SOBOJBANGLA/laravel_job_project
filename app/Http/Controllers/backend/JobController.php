...
class JobController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('backend.job.create',compact('companies','locations','categories','jobtypes')) ;
    }
    ...
    public function edit(Job $job)
    {
        ...
        $categories = Category::all();
        $jobtypes = Jobtype::all();
        return view('backend.job.edit',compact('companies','locations','categories','jobtypes','job')) ;
    }
